...
public class MySqlProjectDao implements IProjectDao {
	...
	public List<Project> selectList() throws Exception {
	    ...
	    try {
			...
			rs = stmt.executeQuery("select PNO, PNAME, STA_DATE, END_DATE, STATE, CRE_DATE, TAGS from PROJECTS order by PNO DESC");
	...
	public Project select(int no) throws Exception {
	    ...
	    try {
			connection = ds.getConnection();
	    	stmt = connection.createStatement();
			rs = stmt.executeQuery(String.format("select PNO, PNAME, CONTENT, STA_DATE, END_DATE, STATE, CRE_DATE, TAGS from PROJECTS WHERE PNO = %d", no));
