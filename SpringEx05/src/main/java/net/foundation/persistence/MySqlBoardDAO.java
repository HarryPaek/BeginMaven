...
public class MySqlBoardDAO implements IBoardDAO {
	...
	public void addAttach(int bno, String fullName) throws Exception {
		logger.info("addAttach() ................");

		Map<String, Object> paramMap = new HashMap<>();
		paramMap.put("bno", bno);
		paramMap.put("fullName", fullName);

		sqlSession.insert(getMapper("addAttach"), paramMap);
	}
	...
	public List<String> getAttach(int bno) throws Exception {
		...
		return sqlSession.selectList(getMapper("getAttach"), bno);
	}
	...
	public void deleteAttach(int bno) throws Exception {
		...
		sqlSession.delete(getMapper("deleteAttach"), bno);
	}
