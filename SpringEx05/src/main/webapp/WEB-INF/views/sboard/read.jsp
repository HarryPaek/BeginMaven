        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="timeline">
                    ...
                    <li class="time-label" id="repliesDiv"><span class="bg-green">Replies List <small id="replycntSamll"> [ ${boardVO.replycnt} ] </small></span></li>
                </ul>
        ...
        $(document).ready(function() {
        	...
        	$('#removeBtn').on('click', function() {
        		...
        		$('.uploadedList li').each(function(index) {
        			fileList.push($(this).attr('data-src'));
        		});
        		
        		if(fileList.length > 0) {
        			$.post('/files/deleteAllFiles', {files:fileList}, function() {});
        		}
